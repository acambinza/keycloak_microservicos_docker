...
var Users = (function (_super) {
    ...
    function Users(client) {
        ...
        _this.getProfile = _this.makeRequest({
            method: 'GET',
            path: '/profile'
        });
        _this.updateProfile = _this.makeRequest({
            method: 'PUT',
            path: '/profile'
        });
