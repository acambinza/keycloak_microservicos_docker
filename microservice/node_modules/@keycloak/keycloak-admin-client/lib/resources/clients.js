...
var Clients = (function (_super) {
    ...
    function Clients(client) {
        ...
        _this.listAllResourcesByScope = _this.makeRequest({
            method: 'GET',
            path: '/{id}/authz/resource-server/scope/{scopeId}/resources',
            urlParamKeys: ['id', 'scopeId']
        });
        _this.listAllPermissionsByScope = _this.makeRequest({
            method: 'GET',
        ...
        _this.updateAuthorizationScope = _this.makeUpdateRequest({
            method: 'PUT',
            path: '/{id}/authz/resource-server/scope/{scopeId}',
            urlParamKeys: ['id', 'scopeId']
        });
        _this.getAuthorizationScope = _this.makeRequest({
            method: 'GET',
            path: '/{id}/authz/resource-server/scope/{scopeId}',
            urlParamKeys: ['id', 'scopeId']
        });
        _this.delAuthorizationScope = _this.makeRequest({
            method: 'DELETE',
            path: '/{id}/authz/resource-server/scope/{scopeId}',
            urlParamKeys: ['id', 'scopeId']
        });
        ...
        _this.updateFineGrainPermission = _this.makeUpdateRequest({
            method: 'PUT',
            path: '/{id}/management/permissions',
            urlParamKeys: ['id']
        });
        _this.listFineGrainPermissions = _this.makeRequest({
            method: 'GET',
            path: '/{id}/management/permissions',
            urlParamKeys: ['id']
        });
